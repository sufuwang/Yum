<template>
	<lBackHeader title="navtitle.txt2">
		<view class="content px-p-30 u-flex-col u-col-center">
			<view class="m-0-center width-688 px-m-t-40 info-box">
				<view class="user-top u-flex-col u-col-center">
					...
					<view
						class="px-m-t-10 px-font-12 u-text-center invit-txt"
						@click="copyTxt(userInfo.invite_code)"
					>
				...
				<view class="u-flex u-row-around px-font-14 u-col-top user-bottom">
					<view class="u-text-center p-item" @click="jumpToLogs">
						<view class="u-font-bold px-font-12 pro-num">{{
							$t("uinfo.txt3")
						}}</view>
						<view class="px-m-t-20 px-font-16 pro-txt u-flex u-row-center">
							...
							<image
								class="rate"
								src="/static/images/home/upper.png"
								mode=""
							></image>
						</view>
					</view>
					...
					<view class="u-text-center p-item" @click="jumpToWithdraw">
						...
						<view class="px-m-t-20 px-font-16 pro-txt2"
							>{{ userInfo.balance }} SGD</view
						>
					</view>
				</view>
			</view>
			<view
				class="m-0-center width-688 px-m-t-40 user-list u-flex u-row-between u-flex-wrap"
			>
				<view
					class="list-item u-flex u-row-between"
			...
			<view
				class="exit-btn px-p-20 u-flex u-row-center width-688"
				@click="exitHandle"
			>
...
<script>
import lBackHeader from "@/layout/l-backHeader/index.vue";
export default {
	components: {
		lBackHeader,
	},
