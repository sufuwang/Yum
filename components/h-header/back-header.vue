		...
		<view class="h-header">
			...
			<view class="cus-header u-flex u-row-between">
				...
				<view class="u-navbar-content-title" v-if="title" :style="[titleStyle]">
					<view class="h-nav-title u-line-1">
						{{ title }}
					</view>
				</view>
				...
				<view class="u-slot-right" @click="goNotic">
					<image class="notic-icon" src="/static/images/common/alert.png" mode=""></image>
				</view>
			</view>
		</view>
		<!-- 解决fixed定位后导航栏塌陷的问题 -->
		<view class="u-navbar-placeholder" :style="{ width: '100%', height: 58 + statusBarHeight + 'px' }"></view>
	</view>
</template>
